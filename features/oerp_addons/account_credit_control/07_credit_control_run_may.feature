...
##############################################################################
       ...
       @credit_management_run    @credit_management_run_may
...
Feature: Ensure that mail credit line generation first pass is correct
  ...
  Scenario: Create run
    ...
    And credit lines should have following values:
     ...
     |     450 | 2012-03-15 | Debtors USD   | 3 time policy | 2012-05-31 | customer_4         | manual|  3.00 | SI_12         | 10 days sommation       | draft     |        450  |  USD    |     
